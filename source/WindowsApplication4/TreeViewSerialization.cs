...
namespace TreeViewSerialization
{
    ...
    public class TreeViewSerializer
    {
        ...
        public String SerializeTreeView(TreeView treeView, string fileName)
        {
        ...
        public void DeserializeTreeView(TreeView treeView, String fileName)
        {
            ...
            try
            {
                StringReader sReader = new StringReader(fileName);
                ...
                while (reader.Read())
                {
                  ...
                  System.Collections.IEnumerator expandEnumerator = expandNodes.GetEnumerator();
                  while (expandEnumerator.MoveNext())
                  {
                      TreeNode tempNode = ((TreeNode)expandEnumerator.Current);
                      tempNode.Expand();
                  }
            }
            finally
